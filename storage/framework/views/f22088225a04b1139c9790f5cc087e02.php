...
<?php $__env->startSection('page_title', 'Kalender - Jadwal Tugas'); ?>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-bold text-slate-900"><?php echo e(now()->format('F Y')); ?></h3>
                ...
                <div class="mb-6">
                    <div class="grid grid-cols-7 gap-2 mb-2">
                        <?php $__currentLoopData = ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="text-center font-semibold text-slate-700 text-sm py-2"><?php echo e($day); ?></div>
                        ...
                        <?php for($i = 1; $i <= 35; $i++): ?>
                            ...
                            <?php else: ?>
                                <div class="p-2 border border-slate-200 rounded-lg hover:bg-indigo-50 cursor-pointer transition-colors h-20 flex flex-col">
                                    <div class="font-semibold text-slate-900 text-sm"><?php echo e($i - 4); ?></div>
                                    <div class="flex-1 text-xs text-slate-600 overflow-hidden">
                                        <?php if(in_array($i - 4, [5, 12, 18, 25])): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\manajemen-tugas\resources\views/calendar/index.blade.php ENDPATH**/ ?>