...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Task Manager'); ?> - Dashboard</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex h-screen bg-gray-50">
        ...
        <aside class="w-64 bg-slate-100 border-r border-slate-200 fixed h-screen overflow-y-auto">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <a href="<?php echo e(route('tasks.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 bg-white rounded-lg hover:bg-indigo-50 hover:text-indigo-600 transition-colors font-medium">
                    ...
                    <a href="<?php echo e(route('calendar.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('projects.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('notifications.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 ml-64 overflow-auto">
            ...
            <div class="bg-white border-b border-slate-200 sticky top-0 z-40">
                <div class="flex items-center justify-between px-6 py-4">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900"><?php echo $__env->yieldContent('page_title', 'Task Manager'); ?></h2>
                    </div>
                    <div class="flex items-center gap-4">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors">
                                ...
                                <span class="hidden md:block text-sm font-medium text-slate-700"><?php echo e(auth()->user()->name); ?></span>
                            ...
                            <div x-show="open" @click.outside="open = false" class="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-lg shadow-lg z-50">
                                <div class="px-4 py-3 border-b border-slate-200">
                                    ...
                                    <p class="text-xs text-slate-600"><?php echo e(auth()->user()->email); ?></p>
                                    <?php if(auth()->user()->role === 'admin'): ?>
                                        <p class="text-xs text-indigo-600 font-semibold mt-1">Administrator</p>
                                    <?php endif; ?>
                                </div>
                                <a href="<?php echo e(route('projects.index')); ?>" class="block px-4 py-2 text-slate-700 hover:bg-slate-50 text-sm">Proyek</a>
                                <a href="#" class="block px-4 py-2 text-slate-700 hover:bg-slate-50 text-sm">Pengaturan</a>
                                <form action="<?php echo e(route('logout')); ?>" method="POST" class="border-t border-slate-200">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\manajemen-tugas\resources\views/layouts/app.blade.php ENDPATH**/ ?>