...
@section('page_title', 'Edit Tag - Query Builder')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm p-8">
            <div class="mb-6 pb-6 border-b border-slate-200">
                ...
                <p class="text-sm text-slate-600 mt-1">Menggunakan <span class="font-mono bg-slate-100 px-2 py-1 rounded">Query Builder - update()</span></p>
            </div>

            <form action="{{ route('tags.query-builder.update', $tag->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <a 
                        href="{{ route('tags.query-builder.show', $tag->id) }}" 
